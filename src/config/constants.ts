...
export const UI_TEXTS = {
  ...
  sections: {
    about: {
      ...
      description: 'Desde nuestra fundación, nos hemos dedicado a proporcionar soluciones ambientales innovadoras y sostenibles para empresas de todos los sectores. Nuestro compromiso con el medio ambiente y la excelencia técnica nos ha convertido en un referente en el sector de la consultoría ambiental.',
      values: {
    ...
    services: {
      ...
      cta: {
        ...
        description: 'Nuestro equipo de expertos está listo para ayudarte a encontrar la mejor solución para tu empresa.'
      }
    },
    blog: {
      title: 'Blog y Novedades',
      subtitle: 'Mantente al día con las últimas noticias y tendencias en sostenibilidad ambiental',
    ...
    contact: {
      title: 'Contacto',
      subtitle: 'Estamos aquí para ayudarte. Contáctanos y te responderemos lo antes posible.',
